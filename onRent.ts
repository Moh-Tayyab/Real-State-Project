...
async function rentHouse() {
  ...
  console.log(
    chalk.bold.greenBright(
      `\tCity is ${select.city}, ${selectSociety.society} Housing Society, in $${price}, Family Members are ${familyMember.fMember}, and your contact number is ${contactNo.phoneNo}.`
    )
  );
